...
#Muestras de forma ordenada la lista de los Inmuebles de forma ordenada
...
#Agrega a la lista un nuevo inmueble, esta debe pasar las correctas verificaciones
...
#Edita un valor de la lista, se debe seleccionar el numero de inmueble
...
#se elimina un inmueble de la lista mostrada
...
#busca dentro de la lista los valores con un 'precio' igual o inferior
...
#FUNCIONES AUXILIARES (ESTAN SE USAN DENTRO DE LAS FUNCIONES PARA FACILITAR LA LECTURA)
...
while True:
    ...
    if opcion == "1":
        inmuebles.append(agregar(inmuebles))
    elif opcion == "2":
        editar(inmuebles)
    elif opcion == "3":
        eliminar(inmuebles)
